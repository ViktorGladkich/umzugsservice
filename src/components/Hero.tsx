  ...
  return (
    <section className="px-0 pb-6 pt-10 min-h-screen bg-white">
      <div className="relative h-[calc(100vh-120px)] min-h-[600px] w-full rounded-3xl md:rounded-[2.5rem] overflow-hidden shadow-2xl bg-neutral-900">
        ...
        <div className="absolute inset-0 flex items-end md:items-center px-8 md:px-20 pb-20 z-10">
          <div className="max-w-3xl">
            <div className="overflow-hidden mb-8 py-2">
              ...
              >
                Besser <br />
                <span className="text-white drop-shadow-lg">umziehen.</span>
              </motion.h1>
            </div>
        ...
        <div className="absolute bottom-0 right-0 z-20 hidden lg:flex items-end">
          <div className="relative flex items-end">
            ...
            <motion.div
              ...
              className="bg-white pt-8 pl-8 pr-12 pb-8 rounded-tl-[32px] relative z-10"
            >
              <div className="flex items-center gap-8">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-[50px] h-[50px] rounded-full border-2 border-white bg-neutral-100 overflow-hidden shadow-sm shrink-0"
                    >
                      <Image
                ...
                <div>
                  <div className="text-xl font-black tracking-tight text-neutral-900 leading-none mb-1 flex items-center gap-2">
                    4.7{" "}
                    <Star className="w-4 h-4 fill-yellow-400 text-yellow-400 pb-0.5" />
                  </div>
